...
// Find the smallest and largest x-value for all points. If there is a 
// line then it should be at y = (minX + maxX) / 2. For each point, make sure t
// hat it has a reflected point in the opposite side.

// For this problem, we first find the smallest and largest x-value for 
// all points and get the line's x-axis is (minX + maxX) / 2, then for each point, 
