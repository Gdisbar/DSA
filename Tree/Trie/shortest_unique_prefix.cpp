...
// NOTE : Assume that no word is prefix of another. In other words, 
// the representation is always possible.
...
// Time complexity of this step is O(N) where N is total number of characters 
// in all words. 
...
// traversed, we check its frequency. If frequency is one, we print all characters 
