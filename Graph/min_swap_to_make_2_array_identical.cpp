...
=======================================================================
// Given two arrays that have the same values but in a different order and having 
// no duplicate elements in it, we need to make a second array the same as a 
// first array using the minimum number of swaps. 
...
//              arrB[] = {4, 6, 8, 3}
//     Output : 2
//     Explanation: we can make arrB to same as arrA in 2 swaps which are shown 
//     below, swap 4 with 8,
//     arrB = {8, 6, 4, 3} swap 8 with 3,   arrB = {3, 6, 4, 8}

// This problem can be solved by modifying the array B. We save the index of array A 
// elements in array B i.e. if ith element of array A is at jth position in array B, 
// then we will make arrB[i] = j 
// For above given example, modified array B will be, arrB = {3, 1, 0, 2}. 
// This modified array represents the distribution of array A element in array 
// B and our goal is to sort this modified array in a minimum number of swaps


Hence,

    swaps = Σi=(1,k)(cycle_size – 1)
...
//minSwapsToSort(b, n) this can be done using merge sort too 
