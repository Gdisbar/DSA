...
//     right corner or top left 1,1,1,1 is equal to bottom 1,1,1,1
...
//     1, 1, 0, 1, 1}}
//     Output: 3 
//     Distinct islands in the example above are: 1, 1 at the top left corner; 1, 
//     1 at the top right corner and 1 at the bottom right corner. We ignore the 
//     island 1, 1 at the bottom left corner since 1, 1 it is identical to the top 
//     right corner. top left 1,1,1 is reflection of bottom right 1,1,1 , so we  
//     ignore that too
...
// the only criteria as we have seen in example 2 above. So how do we know? 
// We could use the position/coordinates of the 1’s. 
// If we take the first coordinates of any island as a base point and then compute 
// the coordinates of other points from the base point, we can eliminate duplicates 
// to get the distinct count of islands. So, using this approach, the coordinates 
// for the 2 islands in example 1 above can be 
// represented as: [(0, 0), (0, 1), (1, 0), (1, 1)].
